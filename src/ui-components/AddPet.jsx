...
export default function AddPet(props) {
  ...
  const [
    textFieldThreeFourFiveTwoTwoSevenZeroEightValue,
    setTextFieldThreeFourFiveTwoTwoSevenZeroEightValue,
  ] = useStateMutationAction("");
  const [
    textFieldThreeFourFiveTwoTwoSevenTwoTwoValue,
    setTextFieldThreeFourFiveTwoTwoSevenTwoTwoValue,
  ] = useStateMutationAction("");
  const [
    textFieldThreeFourFiveTwoTwoSevenOneFiveValue,
    setTextFieldThreeFourFiveTwoTwoSevenOneFiveValue,
  ] = useStateMutationAction("");
  const buttonTwoNineSevenSixSixNineTwoSixOnClick = useDataStoreCreateAction({
    fields: {
      ...
      about: textFieldThreeFourFiveTwoTwoSevenZeroEightValue,
      image: textFieldThreeFourFiveTwoTwoSevenTwoTwoValue,
      color: textFieldThreeFourFiveTwoTwoSevenOneFiveValue,
    },
    model: Pet,
    schema: schema,
  });
  const buttonThreeFourFiveTwoTwoSevenThreeFiveOnClick =
    useDataStoreUpdateAction({
      fields: {
        name: textFieldTwoNineSevenSixSixNineTwoTwoValue,
        age: textFieldTwoNineSevenSixSixNineTwoThreeValue,
      ...
      >
        ...
        >
          ...
          <TextField
            ...
            labelHidden={false}
            variation="default"
            value={textFieldThreeFourFiveTwoTwoSevenZeroEightValue}
            onChange={(event) => {
              setTextFieldThreeFourFiveTwoTwoSevenZeroEightValue(
                event.target.value
              );
            }}
            {...getOverrideProps(overrides, "TextField34522708")}
          ></TextField>
          <TextField
            display="flex"
            gap="8px"
            ...
            labelHidden={false}
            variation="default"
            value={textFieldThreeFourFiveTwoTwoSevenOneFiveValue}
            onChange={(event) => {
              setTextFieldThreeFourFiveTwoTwoSevenOneFiveValue(
                event.target.value
              );
            }}
            {...getOverrideProps(overrides, "TextField34522715")}
          ></TextField>
          <TextField
            display="flex"
            gap="8px"
            ...
            labelHidden={false}
            variation="default"
            value={textFieldThreeFourFiveTwoTwoSevenTwoTwoValue}
            onChange={(event) => {
              setTextFieldThreeFourFiveTwoTwoSevenTwoTwoValue(
                event.target.value
              );
            }}
            {...getOverrideProps(overrides, "TextField34522722")}
          ></TextField>
        </Flex>
        <Divider
          height="1px"
        ...
        >
          ...
          <Button
            ...
            children="Update"
            onClick={() => {
              buttonThreeFourFiveTwoTwoSevenThreeFiveOnClick();
            }}
            {...getOverrideProps(overrides, "Button34522735")}
          ></Button>
        </Flex>
      </Flex>
    </Flex>
